...
function K(name) {
  return process.env[name] || keyStore[name] || '';
}
    ...
    voice: {
      providers: [
        ...
        },
        {
          ...
          enabled: false,
          appId: K('XFYUN_APPID'),
          apiKey: K('XFYUN_APIKEY'),
          apiSecret: K('XFYUN_APISECRET'),
          endpoint: 'https://tts-api.xfyun.cn/v2/tts',
        },
        {
          name: 'volcano-tts',
          enabled: false,
          apiKey: K('VOLCANO_KEY'),
          appId: K('VOLCANO_APPID'),
